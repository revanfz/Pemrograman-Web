...
<img src="./1/1 Before.png" alt="Website sebelum manipulasi DOM" width="85%">

Setelah dilakukan manipulasi DOM, maka pada bagian tanggal akan muncul teks yang sudah ditambahkan.

<img src="./1/1 After.png" alt="Website setelah manipulasi DOM" width="85%">

Script yang digunakan dapat dilihat pada gambar dibawah

<img src="./1/1 Code.png" alt="Script manipulasi DOM" width="85%">
...
<img src="./2/2 Before.png" alt="Website sebelum manipulasi DOM" width="85%">
...
<img src="./2/2 After.png" alt="Website sesudah manipulasi DOM" width="85%">

Script yang digunakan untuk menghasilkan output seperti diatas dapat dilihat pada gambar dibawah

<img src="./2/2 Code.png" alt="Script manipulasi DOM" width="85%">
...
<img src="./3/3 Before.png" alt="Website sebelum manipulasi DOM" width="85%">
...
<img src="./3/3 After.png" alt="Website sesudah manipulasi DOM" width="85%">
...
<img src="./3/3 Result.png" alt="Halaman setelah tombol diklik" width="85%">

Script untuk memanipulasi DOM dapat dilihat pada gambar dibawah

<img src="./3/3 Code.png" alt="Script manipulasi DOM" width="85%">
